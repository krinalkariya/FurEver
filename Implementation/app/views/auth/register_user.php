...
$phone = $phone ?? '';
?>
<form method="post" action="<?= APP_URL ?>/register/user" data-validate="auth" novalidate>
  ...
  <div class="mb-3">
    ...
    <div class="input-group flex-wrap">
      ...
      <input name="name" class="form-control <?= isset($errors['name'])?'is-invalid':'' ?>" required minlength="2" maxlength="100" placeholder="Enter your full name" value="<?= htmlspecialchars($name) ?>">
  ...
  <div class="mb-3">
    ...
    <div class="input-group flex-wrap">
      ...
      <input name="city" class="form-control <?= isset($errors['city'])?'is-invalid':'' ?>" required minlength="2" maxlength="50" placeholder="Enter your city" value="<?= htmlspecialchars($city) ?>">
  ...
  <div class="mb-3">
    ...
    <div class="input-group flex-wrap">
      ...
      <input type="email" name="email" class="form-control <?= isset($errors['email'])?'is-invalid':'' ?>" required placeholder="you@example.com" value="<?= htmlspecialchars($email) ?>">
  ...
  <button class="btn btn-primary w-100">Create & Verify</button>
